					...
					<ul class="nav navbar-nav">
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu">
								...
								<li class=""><a href="unitManager.html">单位管理</a></li>
							</ul>
						</li>
						<li class="active"><a href="userManager.html">用户管理</a></li>
					</ul>
						...
						<tr>
							...
							<td>
								<div class="btn-group">
									...
									<button type="button" class="btn" style="background-color:#D4D4D4" data-toggle="modal" data-target="#distModal">
												...
												<div id="collegeBodyOne" class="panel-collapse collapse">
													<div class="panel-body">
														<div class="collegeList">
															<label for="xinxi"><input type="checkbox" name="" id="xinxi" value="" />信息学院</label>
															<label for="dali"><input type="checkbox" name="" id="dali" value="" />达利学院</label>
															<label for="jidian"><input type="checkbox" name="" id="jidian" value="" />机电学院</label>
														</div>
													</div>
												</div>
											</div>
